use tokio_pub_sub::SimpleSubscriber;
use tokio_pub_sub_macros::{DerivePublisher, DeriveSubscriber};
...
pub struct DataConsumerService {
    ...
    timer_notification_subscriber: SimpleSubscriber<DataConsumerTimerNotification>,
}
